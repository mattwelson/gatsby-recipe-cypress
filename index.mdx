...
<File
  ...
  content={`https://raw.githubusercontent.com/mattwelson/gatsby-recipe-cypress/master/cypress/support/index.js`}
/>
...
<File
  path="cypress.json"
  content={`https://raw.githubusercontent.com/mattwelson/gatsby-recipe-cypress/master/cypress.json`}
/>
